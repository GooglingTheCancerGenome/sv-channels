...
def get_channel_labels():
    ...
    labels.append("left_clipped_reads_F")
    labels.append("left_clipped_reads_R")
    labels.append("right_clipped_reads_F")
    labels.append("right_clipped_reads_R")
    labels.append("disc_right_clipped_reads_F")
    labels.append("disc_right_clipped_reads_R")
    labels.append("disc_left_clipped_reads_F")
    labels.append("disc_left_clipped_reads_R")

    labels.append("left_split_reads_F")
    labels.append("left_split_reads_R")
    labels.append("right_split_reads_F")
    labels.append("right_split_reads_R")

    labels.append("CIGAR_D_left_reads_F")
    labels.append("CIGAR_D_left_reads_R")
    labels.append("CIGAR_D_right_reads_F")
    labels.append("CIGAR_D_right_reads_R")
    labels.append("CIGAR_I_right_reads_F")
    labels.append("CIGAR_I_right_reads_R")
