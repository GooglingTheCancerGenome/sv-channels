...
load_vcf <- function(vcf_file, svtype, caller)
{
  ...
  vcf_gr <- vcf_gr[seqnames(vcf_gr) %in% paste('chr',c(1:22),sep='')]
...
p <-
  add_argument(
    ...
    type = "character",
    default = '/Users/lsantuari/Documents/Projects/GTCG/sv-channels/sv-channels_manuscript/1KG_trios/results/manta_loocv/HG03992/callsets_HG03992.csv'
  )
p <-
  add_argument(p,
               "-t",
               ...
               type = "character",
               default = '/Users/lsantuari/Documents/Projects/GTCG/sv-channels/sv-channels_manuscript/1KG_trios/results/truth_sets/HG03992.DEL.vcf')
p <-
  add_argument(p,
               "-s",
               help = "sample name",
...
p <-
  add_argument(p,
               ...
               type = "character",
               default = '/Users/lsantuari/Documents/Processed/SPIDER/split_reads/NA12878/split_reads_real.bedpe')
...
p <-
  add_argument(p,
               ...
               help = "Filename",
               type = "character",
               default = '/Users/lsantuari/Documents/Projects/GTCG/sv-channels/sv-channels_manuscript/1KG_trios/results/manta_loocv/HG03992/HG03992')
