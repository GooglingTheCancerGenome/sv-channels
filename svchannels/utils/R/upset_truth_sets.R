...
sample_list <- c('HG00420', 'HG01053', 'HG01114', 'HG01881',
                 'HG02018', 'HG02924', 'HG03992', 'NA06991')
sv_regions <- list()
...
{
  if(names(sv_regions)[i]!='HG00420_truth_set')
  {
    print(names(sv_regions)[i])
    my.hits <- findBreakpointOverlaps(
      sv_regions[[i]],
      sv_regions[['HG00420_truth_set']],
